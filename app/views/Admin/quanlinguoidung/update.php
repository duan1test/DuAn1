<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <li class="">Cập nhật người dùng</li>
      <form action="indexadmin.php?act=upduser" method="POST">
        <div class="content">
          <label for="">ID</label><br>
        </div>
        <div class="content">
          <label for="">Tên user:</label><br>
          <input type="text" name="ten_user" value="<?= $ten ?>">
        </div>
        <div class="content">
        ...
        <div class="content">
          ...
          <input type="text" name="ngay_sinh" value="<?= $ngay_sinh ?>">
        </div>
        <div class="content">
        ...
        <div class="content">
          ...
          <select name="role" id="">
              ...
              <option <?php if($role_id == 2) echo "selected" ?> value="2">User</option>
            </select>
        </div>
        <br>
        <div class="content">
